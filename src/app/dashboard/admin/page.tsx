...
import { Plus, Users, DollarSign, Package, ShoppingCart, Ban, ShieldCheck, Trash2 } from "lucide-react";
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-64 glass-panel rounded-2xl p-6 h-fit border border-card-border space-y-2">
            ...
            <Link
              href="/items/add"
              className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 border border-dashed border-card-border"
            >
